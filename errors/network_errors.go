...
const (
	...
	ErrMsgInvalidUserContent               = "User content data is invalid"
	ErrMsgUserContentMissingRequiredFields = "User content required fields are missing"
	ErrMsgUserContentParentNotFound        = "Parent user content not found"
	ErrMsgUserContentRootNotFound          = "Root user content not found"
	ErrMsgUserContentVersionConflict       = "Parent user content is not the latest version"
)
