...
func LoadGenesisConfig(path string) (*GenesisConfig, error) {
	...
	log.Printf("[config] Successfully loaded config: LeaderSchedule=%d entries, Faucet=%+v, Staking.Enabled=%v", len(cfgFile.Config.LeaderSchedule), cfgFile.Config.Alloc, cfgFile.Config.Staking.Enabled)
