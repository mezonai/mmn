...
const (
	HealthService_Check_FullMethodName = "/mmn.HealthService/Check"
	HealthService_Watch_FullMethodName = "/mmn.HealthService/Watch"
)
...
func (c *healthServiceClient) Watch(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HealthCheckResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HealthService_ServiceDesc.Streams[0], HealthService_Watch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Empty, HealthCheckResponse]{ClientStream: stream}
...
func (UnimplementedHealthServiceServer) Watch(*Empty, grpc.ServerStreamingServer[HealthCheckResponse]) error {
...
func _HealthService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HealthServiceServer).Watch(m, &grpc.GenericServerStream[Empty, HealthCheckResponse]{ServerStream: stream})
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "mmn/proto/health.proto",
}
