  ...
  constructor() {
    super("mmn.TxMeta", [
      ...
      },
      {
        ...
        name: "status",
        kind: "enum",
        T: () => ["mmn.TxMeta.Status", TxMeta_Status],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated mmn.TxMeta txs */ 2:
          message.txs.push(
            TxMeta.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
...
class GetCurrentNonceRequest$Type extends MessageType<GetCurrentNonceRequest> {
  ...
  create(
    value?: PartialMessage<GetCurrentNonceRequest>,
...
class GetCurrentNonceResponse$Type extends MessageType<GetCurrentNonceResponse> {
  ...
  create(
    value?: PartialMessage<GetCurrentNonceResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetCurrentNonceResponse,
  ): GetCurrentNonceResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class GetAccountByAddressRequest$Type extends MessageType<GetAccountByAddressRequest> {
  ...
  create(
    value?: PartialMessage<GetAccountByAddressRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAccountByAddressRequest,
  ): GetAccountByAddressRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class GetAccountByAddressResponse$Type extends MessageType<GetAccountByAddressResponse> {
  ...
  create(
    value?: PartialMessage<GetAccountByAddressResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAccountByAddressResponse,
  ): GetAccountByAddressResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* mmn.AccountData account */ 1:
          message.account = AccountData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.account,
  ...
  internalBinaryWrite(
    ...
    if (message.account)
      AccountData.internalBinaryWrite(
        message.account,
 ...
 */
export const GetAccountByAddressResponse =
  new GetAccountByAddressResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const AccountService = new ServiceType("mmn.AccountService", [
  ...
  },
  {
    name: "GetTxHistory",
    options: {},
    I: GetTxHistoryRequest,
    O: GetTxHistoryResponse,
  },
  {
  ...
  },
  {
    ...
    options: {},
    I: GetAccountByAddressRequest,
    O: GetAccountByAddressResponse,
  },
]);
