  ...
  constructor() {
    super("mmn.TransactionData", [
      ...
      },
      {
        ...
        name: "status",
        kind: "enum",
        T: () => ["mmn.TransactionStatus", TransactionStatus],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* mmn.TxMsg tx_msg */ 1:
          message.txMsg = TxMsg.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.txMsg,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* mmn.TxInfo tx */ 2:
          message.tx = TxInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.tx,
...
class GetTransactionStatusRequest$Type extends MessageType<GetTransactionStatusRequest> {
  ...
  create(
    value?: PartialMessage<GetTransactionStatusRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetTransactionStatusRequest,
  ): GetTransactionStatusRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
export const GetTransactionStatusRequest =
  new GetTransactionStatusRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class SubscribeTransactionStatusRequest$Type extends MessageType<SubscribeTransactionStatusRequest> {
  ...
  create(
    value?: PartialMessage<SubscribeTransactionStatusRequest>,
  ): SubscribeTransactionStatusRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined)
      reflectionMergePartial<SubscribeTransactionStatusRequest>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SubscribeTransactionStatusRequest,
  ): SubscribeTransactionStatusRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
export const SubscribeTransactionStatusRequest =
  new SubscribeTransactionStatusRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetPendingTransactionsRequest$Type extends MessageType<GetPendingTransactionsRequest> {
  ...
  create(
    value?: PartialMessage<GetPendingTransactionsRequest>,
  ): GetPendingTransactionsRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined)
      reflectionMergePartial<GetPendingTransactionsRequest>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetPendingTransactionsRequest,
  ): GetPendingTransactionsRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
 ...
 */
export const GetPendingTransactionsRequest =
  new GetPendingTransactionsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetPendingTransactionsResponse$Type extends MessageType<GetPendingTransactionsResponse> {
  ...
  create(
    value?: PartialMessage<GetPendingTransactionsResponse>,
    ...
    message.error = "";
    if (value !== undefined)
      reflectionMergePartial<GetPendingTransactionsResponse>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetPendingTransactionsResponse,
  ): GetPendingTransactionsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated mmn.TransactionData pending_txs */ 2:
          message.pendingTxs.push(
            TransactionData.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
 ...
 */
export const GetPendingTransactionsResponse =
  new GetPendingTransactionsResponse$Type();
/**
