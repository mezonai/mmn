...
const file_tx_proto_rawDesc = "" +
	...
	"\x06status\x18\a \x01(\x0e2\x16.mmn.TransactionStatusR\x06status\"\xd9\x01\n" +
	"\x05TxMsg\x12\x12\n" +
	...
	"\atx_hash\x18\x01 \x01(\tR\x06txHash\"\xa6\x02\n" +
	...
	"\n" +
	"extra_info\x18\b \x01(\tR\textraInfo\"#\n" +
