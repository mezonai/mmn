...
func (x *TransactionData) GetTransactionType() int32 {
	if x != nil {
...
const file_tx_proto_rawDesc = "" +
	...
	"\atx_hash\x18\x01 \x01(\tR\x06txHash\"\xfe\x02\n" +
	"\x06TxInfo\x12\x16\n" +
	...
	"\x04slot\x18\a \x01(\x04R\x04slot\x12\x1d\n" +
	"\n" +
	...
	"\fblock_height\x18\r \x01(\x04R\vblockHeight\"d\n" +
...
var file_tx_proto_depIdxs = []int32{
	...
	7,  // 11: mmn.TxService.GetTxByHash:output_type -> mmn.GetTxByHashResponse
	8,  // 12: mmn.TxService.SubscribeTransactionStatus:output_type -> mmn.TransactionStatusInfo
	11, // 13: mmn.TxService.GetPendingTransactions:output_type -> mmn.GetPendingTransactionsResponse
